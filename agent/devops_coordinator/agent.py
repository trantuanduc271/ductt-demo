...
from secure_devops_bot.agent import root_agent as secure_devops_agent

# Load environment variables from parent agent directory
env_path = parent_dir / ".env"
load_dotenv(env_path)

COORDINATOR_INSTRUCTION = """You are an intelligent DevOps coordinator assistant that helps users manage Apache Airflow workflows, Kubernetes clusters, and secure DevOps operations.
...
2. Delegate to the appropriate specialized assistant:
   ...
   - Use secure_devops_assistant for: metrics analysis, security-conscious operations, triggering allowlisted DAGs
...
- Metrics, security-sensitive operations, allowlisted DAG triggers → Delegate to secure_devops_assistant
